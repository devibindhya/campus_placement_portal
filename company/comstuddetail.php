...
<?php
  session_start();
	...
	<header id="header">
		<div class="container">
			<a href="index.html" id="logo" title="Hi">Hi</a>
		...
		<th colspan='3'>Operations</th>
				...
				?>
			     <tr>
				   ...
				   <td><a class="link" href="callform.php?id=<?php echo $res['idno']; ?>">Call letter </a></td>
				   <td><a class="link" href="callreject.php?id=<?php echo $res['idno']; ?>">Reject </a></td>
				   </tr>
	            <?php 
                   $c++;				
				   }   
