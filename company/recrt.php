...
<body>
		...
		<div class="container">
			...
			<nav id="menu">
				...
				<ul>
					...
					<li><a href="compnylogin.php">Company Login/Signup</a></li>
	...
	<footer id="footer">
		<div class="container">
			...
			<p class="copy">Copyright 2017 Demn University. Designed by <a href="" title="Designs" target="_blank">n</a>. All rights reserved.</p>
		</div>
		<!-- / container -->
	</footer>
	<!-- / footer -->
