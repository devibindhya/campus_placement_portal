...
<header id="header">
	...
	<table align="center">
		...
		<th colspan='3'>Operations</th>-->
				...
				/* SHOW THE COUNT OF STUDENTS PLACED IN THE PARTICULAR COMPANY */
				$stat=1;
				$qry=$dbh->prepare("SELECT company_name, COUNT( studidno ) AS count FROM callletter WHERE STATUS =? GROUP BY comid having comid=?");
			    $val=array($stat,$cid);
				$exe=$qry->execute($val);
