...
<head>
	...
	<![endif]-->
	            <!--ADMIN VIEW NEW CANDIDATE REQUEST FOR APPROVAL -->
		<style>
...
<body>
	...
	<table>
		...
		<th colspan='3'>Operations</th>
		       ...
		       <!-- New request from students for approval will display here-->
				<?php
                ...
                $res1=$qry1->fetch();
				$count=$res1['count']; 
				$status=0;//admin need to accept 
				
				
				$qry=$dbh->prepare("select * from studreg where status=?");
				$val=array($status);
				$exe=$qry->execute($val);
				...
				?>
			     <tr>
				   ...
				   <td><a class="link" href="addnewstud.php?idno=<?php echo $res['idno']?>">Add</a></td>
	...
	<footer id="footer">
		<div class="container">
			...
			<p class="copy">Copyright 2017 Demn University. Designed by <a href="" title=" Design" target="_blank">Design</a>. All rights reserved.</p>
		</div>
		<!-- / container -->
	</footer>
	<!-- / footer -->
