...
<body>
             <!--ADMIN Placement Statistics Report-->
	<header id="header">
		<div class="container">
	...
	<table align="center">
		...
		<th>Placed Students</th>
		        ...
		        /* Table shows the no:of students placed in different companies*/
				$stat=1;
				$qry=$dbh->prepare("SELECT company_name, COUNT( studidno ) 
					 AS count FROM callletter WHERE STATUS =? GROUP BY comid ");
			    $val=array($stat);
				$exe=$qry->execute($val);
