...
<head>
	...
	<![endif]-->
	                   <!--ADMIN CAN SEE THE PENDING REQUEST FROM COMPANIES FOR APPROVAL -->
		<style>
...
<body>
	...
	<div class="content">
		<div class="container">
			<h1 class="heading">New Company Request</h1>
	...
	<table>
		...
		<th colspan='3'>Operations</th>
		         ...
		         <!-- Show all the pending company request from database where status =0  -->
				<?php
				...
				$qry=$dbh->prepare("select * from companyreg where status=?");
				$val=array($status);
				$exe=$qry->execute($val);
				...
				?>
			     <tr>
				   ...
				   <td><a class="link" href="addcomp.php?comid=<?php echo $res['comid']?>">Add </a></td>
				  <!--  <td> <a class="link" href="studedit.php?id=" > Edit </a></td> -->
				   <td><a class="link" href="rejectcomp.php?comid=<?php echo $res['comid']?>">Reject </a></td>
				   </tr>
	            <?php 
				$c++;
				 }   ?>
