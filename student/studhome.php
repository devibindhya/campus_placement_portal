...
<body>      <!-- STUDENT HOME PAGE -->
	...
	<header id="header">
		<div class="container">
			<a href="#adminhome.php" id="logo" title="LBSITW">LBS ITW</a>
			<div class="menu-trigger"></div>
			<nav id="menu">
			<ul>
				    <li><a href="studhome.php">Home</a></li>
					<li><a href="#studevents.php">Events</a></li>
		...
		<div class="container">
			...
			<article>
				...
				<div class="info">
					...
					<a class="more" href="studevents.php">Read more</a>
				</div>
			</article>
			<article>
				<div class="current-date">
			...
			<div class="btn-holder">
				<a class="btn blue" href="studevents.php">See all upcoming events</a>
			</div>
		</div>
		<!-- / container -->
	</section>
