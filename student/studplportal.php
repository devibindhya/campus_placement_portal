...
<body>
	...
	<div class="content">
		<div class="container">
			<h1 class="single">Let's start </h1>
			...
			<aside id="sidebar">
				<div class="widget sidemenu">
					<ul>
						<li><a href="studplstat.php">Placement Statistics<span class="nr">98</span></a></li>
						<li class="current"><a href="studrecpro.php">Recruitment Process<span class="nr">16</span></a></li>
						<li><a href="studedit.php?id=<?php echo $id; ?>" >Edit Details<span class="nr">175</span></a></li>
						<li><a href="studevents.php">Upcoming Events<span class="nr">87</span></a></li>
						<li><a href="studcallletter.php">View Call Letters<span class="nr">87</span></a></li>
					</ul>
				</div>
			</aside>
			<!-- / sidebar -->
